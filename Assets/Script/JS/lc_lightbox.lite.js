...
(function ($) {
  ...
  var lb_code =
    ...
    '<div id="lcl_nav_cmd">' +
    '<div class="lcl_icon lcl_prev bubu" title="ორ"><i class="fa-solid fa-angle-left"></i></div>' +
    '<div class="lcl_icon lcl_play bubu"><i class="fa-solid fa-play"></i></div>' +
    '<div class="lcl_icon lcl_next bubu" title="next"><i class="fa-solid fa-chevron-right"></i></div>' +
    '<div class="lcl_icon lcl_counter"></div>' +
    '<div class="lcl_icon lcl_right_icon lcl_close" title="close"><i class="fa-solid fa-xmark"></i></div>' +
    '<div class="lcl_icon lcl_right_icon lcl_fullscreen" title="toggle fullscreen"><i class="fa-solid fa-expand"></i></div>' +
    '<div class="lcl_icon lcl_right_icon lcl_txt_toggle" title="toggle text"><i class="fa-solid fa-file-lines"></i></div>' +
    '<div class="lcl_icon lcl_right_icon" title="download"><i class="fa-solid fa-arrow-down"></i></div>' +
    '<div class="lcl_icon lcl_right_icon lcl_thumbs_toggle" title="toggle w"><i class="fa-solid fa-eye"></i></div>' +
    '<div class="lcl_icon lcl_right_icon lcl_socials" title="toggle socials"><i class="fa-solid fa-share"></i></div>' +
    "</div>" +
  ...
  var lcl = function (obj, settings) {
    ...
    var lcl_vars = {
      ...
      is_arr_instance:
        typeof obj != "string" && typeof obj[0].childNodes == "undefined"
          ? true
          : false, // true if lightbox is initialized usign direct array immission
      elems_count:
        typeof obj != "string" && typeof obj[0].childNodes == "undefined"
          ? obj.length
          : $(obj).length, // elements count at the moment of lb initialization
    ...
    var attr_or_selector_data = function ($elem, subj_key) {
      ...
      if (subj.indexOf("> ") !== -1) {
        return $elem.find(subj.replace("> ", "")).length
          ? $.trim($elem.find(subj.replace("> ", "")).html())
          : "";
      } else {
        return typeof $elem.attr(subj) != "undefined"
          ? revert_html_entit($elem.attr(subj))
          : "";
      }
    };
    ...
    var setup_elems_obj = function ($subj) {
      ...
      $subj.each(function () {
        ...
        if (
          lcl_ai_vars.gallery_hook_val &&
          $e.attr(o.gallery_hook) != lcl_ai_vars.gallery_hook_val
        ) {
          return true;
        }
        ...
        if (already_man) {
          ...
          if (type != "unknown") {
            var el = {
              ...
              title: o.show_title
                ? attr_or_selector_data($e, "title_attr")
                : "",
              txt: o.show_descr ? attr_or_selector_data($e, "txt_attr") : "",
              author: o.show_author
                ? attr_or_selector_data($e, "author_attr")
                : "",
              thumb:
                o.thumb_attr && typeof o.thumb_attr != "undefined"
                  ? $e.attr(o.thumb_attr)
                  : "",

              width:
                type != "image" && typeof $e.data("lcl-w") != "undefined"
                  ? $e.data("lcl-w")
                  : false,
              height:
                type != "image" && typeof $e.data("lcl-h") != "undefined"
                  ? $e.data("lcl-h")
                  : false,

              force_over_data:
                typeof $e.data("lcl-force-over-data") != "undefined"
                  ? parseInt($e.data("lcl-force-over-data"), 10)
                  : "",
              force_outer_cmd:
                typeof $e.data("lcl-outer-cmd") != "undefined"
            ...
            if (type == "image") {
              el.download =
                typeof $e.data("lcl-path") != "undefined"
                  ? $e.data("lcl-path")
                  : src;
            } else {
              el.download = false;
    ...
    var el_type_finder = function (src, forced_type) {
      ...
      src = src.toLowerCase();
      var img_regex =
        /^(http|https)?:\/\/(?:[a-z\-]+\.)+[a-z]{2,6}(?:\/[^\/#?]+)+\.(?:jpe?g|gif|png)$/;

      if (img_regex.test(src)) {
        // image matching
        return "image";
      }
    ...
    var close_img_preload = function () {
      ...
      if (lcl_ai_vars.elem_index > 0) {
        // prev

        maybe_preload(false, lcl_ai_vars.elem_index - 1);
      }
      if (lcl_ai_vars.elem_index != lcl_ai_vars.elems.length - 1) {
        // next
        maybe_preload(false, lcl_ai_vars.elem_index + 1);
      }
    };
    ...
    var maybe_preload = function (show_when_ready, el_index, cache_check) {
      ...
      if (typeof el_index == "undefined") {
        // if lightbox has alraedy been closed
        return false;
      }
      ...
      if (v.elems[el_index].type == "image") {
        var to_preload =
          v.elems[el_index].type == "image"
            ? v.elems[el_index].src
            : v.elems[el_index].poster;
      } else {
        var to_preload = "";
      }
    ...
    var elems_parsing = function (inst_obj, $clicked_obj) {
      ...
      if (vars.is_arr_instance) {
        ...
        $.each(inst_obj, function (i, v) {
          ...
          var el_type =
            typeof v.type == "undefined" && o.global_type
              ? o.global_type
              : false;
          ...
          if (el_type && $.inArray(el_type, ["image"]) !== -1) {
            if (typeof v.src != "undefined" && v.src) {
              ...
              el.title =
                typeof v.title == "undefined" ? "" : revert_html_entit(v.title);
              el.txt =
                typeof v.txt == "undefined" ? "" : revert_html_entit(v.txt);
              el.author =
                typeof v.author == "undefined"
                  ? ""
                  : revert_html_entit(v.author);

              el.width = typeof v.width == "undefined" ? false : v.width;
              el.height = typeof v.height == "undefined" ? false : v.height;

              el.force_over_data =
                typeof v.force_over_data == "undefined"
                  ? false
                  : parseInt(v.force_over_data, 10);
              el.force_outer_cmd =
                typeof v.force_outer_cmd == "undefined"
                  ? false
                  : v.force_outer_cmd;
              ...
              if (el_type == "image") {
                el.download =
                  typeof v.download != "undefined" ? v.download : v.src;
              } else {
                el.download = false;
              }
      ...
      // if is from DOM object - prepare elements object
        ...
        if (o.live_elements && vars.elems_selector) {
          var consider_group =
            ...
            o.gallery &&
            o.gallery_hook &&
            typeof $(obj[0]).attr(o.gallery_hook) != "undefined"
              ? true
              : false;

          var sel = consider_group
            ? vars.elems_selector +
              "[" +
              o.gallery_hook +
              "=" +
              $clicked_obj.attr(o.gallery_hook) +
              "]"
            : vars.elems_selector;
          $subj = $(sel);
        }
    ...
    var open_lb = function (inst_obj, $clicked_obj) {
      ...
      v.gallery_hook_val =
        ...
        o.gallery &&
        o.gallery_hook &&
        typeof $co.attr(o.gallery_hook) != "undefined"
          ? $co.attr(o.gallery_hook)
          : false;
    ...
    var setup_code = function () {
      ...
      // lightbox max sizes
      $("#lcl_wrap")
        .attr("data-lcl-max-w", o.max_width)
        .attr("data-lcl-max-h", o.max_height);
      ...
      if (
        o.tn_hidden === true ||
        (typeof o.tn_hidden == "number" &&
          ($(window).width() < o.tn_hidden || $(window).height() < o.tn_hidden))
      ) {
      ...
      if (
        o.txt_hidden === true ||
        (typeof o.txt_hidden == "number" &&
          ($(window).width() < o.txt_hidden ||
            $(window).height() < o.txt_hidden))
      ) {
      ...
      if (!o.fullscreen) {
        ...
        o.fs_only === true ||
        (typeof o.fs_only == "number" &&
          ($(window).width() < o.fs_only || $(window).height() < o.fs_only))
      ) {
        $(".lcl_fullscreen").remove();
      ...
      if (!o.thumbs_nav || lcl_ai_vars.elems.length < 2 || !o.gallery) {
        ...
        css +=
          "#lcl_window {margin-top: " + (o.thumbs_h - th_margins) * -1 + "px;}";
      ...
      if (o.padding) {
        css +=
          "#lcl_subj, #lcl_txt, #lcl_nav_cmd {margin: " + o.padding + "px;}";
      }
      if (o.radius) {
        css +=
      ...
      if (o.cmd_position == "inner" && o.ins_close_pos == "corner") {
        css +=
          "#lcl_corner_close {" +
          "top: " +
          (o.border_w + Math.ceil($("#lcl_corner_close").outerWidth() / 2)) *
            -1 +
          "px;" +
          "right: " +
          (o.border_w + Math.ceil($("#lcl_corner_close").outerHeight() / 2)) *
            -1 +
          ";" +
          "}";
      ...
      $("head").append(
        '<style type="text/css" id="lcl_inline_style">' +
          ...
          "-webkit-transition-duration: " +
          (o.open_close_time - o.ol_time_diff) +
          "ms; transition-duration: " +
          (o.open_close_time - o.ol_time_diff) +
          "ms;" +
          "}" +
      ...
      if (o.remove_scrollbar) {
        lcl_ai_vars.html_style =
          typeof jQuery("html").attr("style") != "undefined"
            ? jQuery("html").attr("style")
            : "";
        lcl_ai_vars.body_style =
          typeof jQuery("body").attr("style") != "undefined"
      ...
      if (
        el.type != "image" ||
        (el.type == "image" && typeof v.img_sizes_cache[el.src] != "undefined")
      ) {
      ...
      if (!lcl_ai_vars.is_arr_instance) {
        var $subj = lcl_ai_vars.elems_selector
    ...
    var css_size_to_px = function (size, dimension, ignore_max) {
      ...
      var win_w =
        $(window).width() -
        parseInt($wrap.css("padding-left"), 10) -
        parseInt($wrap.css("padding-right"), 10);
      var win_h =
        $(window).height() -
    ...
    /* set element sizes */
    var size_elem = function (el, flags, txt_und_sizes) {
      // flags: no_txt_under, inner_cmd_checked
      var o = lcl_ai_opts;
      var v = lcl_ai_vars;
      var w, h;
      ...
      var add_space = fs_mode
        ? 0
        : parseInt(o.border_w, 10) * 2 + parseInt(o.padding, 10) * 2;

      // is side-text layout? remove forced on hover
      if (
        typeof flags.side_txt_checked == "undefined" &&
        (typeof flags.no_txt_under == "undefined" || !flags.no_txt_under)
      ) {
      ...
      var side_txt =
        ...
        $.inArray(o.data_position, ["rside", "lside"]) !== -1 &&
        elem_has_txt(el)
          ? $("#lcl_txt").outerWidth()
          : 0;
      ...
      // has thumbs nav?
      var thumbs_nav =
        !fs_mode && $("#lcl_thumbs_nav").length && !$(".lcl_tn_hidden").length
          ? $("#lcl_thumbs_nav").outerHeight(true) -
            parseInt($("#lcl_wrap").css("padding-bottom"), 10)
          : 0;

      // outer commands?
      var cmd_h =
        !fs_mode && $(".lcl_outer_cmd").length
          ? $(".lcl_close").outerHeight(true) +
      ...
      var max_w = fs_mode
        ? $(window).width()
        : Math.floor(css_size_to_px(max_w_attr, "w")) - horiz_add_space;
      var max_h = fs_mode
        ? $(window).height()
        : Math.floor(css_size_to_px(max_h_attr, "h")) - vert_add_space;
        ...
        switch (el.type) {
          case "image": // discard forced sizes
            ...
            if (
              elem_has_txt(el) &&
              !$(".lcl_hidden_txt").length &&
              o.data_position == "under" &&
              typeof flags.no_txt_under == "undefined"
            ) {
      ...
      var timing = $(".lcl_first_sizing").length
        ? o.open_close_time + 20
        : o.animation_time; // +20 trick used to let CSS execute the opening timing
      if (
    ...
    var txt_under_h = function (curr_w, curr_h, max_height, recursive_count) {
      ...
      lcl_txt_under_calc = setTimeout(function () {
        ...
        if (
          overflow > 0 &&
          (typeof recursive_count == "undefined" || recursive_count < 10)
        ) {
          ...
          if (new_w < tot || new_h < tot) {
            $("#lcl_wrap")
              ...
              .addClass("lcl_force_txt_over"); // screen too small or image excessively tall - switch to text over
            $("#lcl_subj").css("maxHeight", "none");
    ...
    var inner_to_outer_cmd = function (el, window_width) {
      ...
      if (!fs_mode && lcl_ai_vars.inner_cmd_w === false) {
        ...
        jQuery("#lcl_nav_cmd .lcl_icon").each(function () {
          if (
            ($(this).hasClass("lcl_prev") || $(this).hasClass("lcl_next")) &&
            o.nav_btn_pos == "middle"
          ) {
            return true;
          }

          lcl_ai_vars.inner_cmd_w =
            lcl_ai_vars.inner_cmd_w + $(this).outerWidth(true);
        });
      }
      ...
      if (
        fs_mode ||
        el.force_outer_cmd ||
        window_width <= lcl_ai_vars.inner_cmd_w
      ) {
    ...
    var switch_elem = function (new_el, slideshow_switch) {
      ...
      if (typeof lcl_slideshow != "undefined") {
        ...
        if (
          typeof slideshow_switch == "undefined" ||
          (!carousel && new_el == v.elems.length - 1)
        ) {
          lcl_stop_slideshow();
        }
      }
      ...
      setTimeout(function () {
        ...
        if (typeof lcl_ai_opts.on_elem_switch == "function") {
          lcl_ai_opts.on_elem_switch.call(
            null,
            lcl_ai_opts,
            lcl_ai_vars,
            new_el
    ...
    var progbar_animate = function (first_run) {
      ...
      lcl_pb_timeout = setTimeout(function () {
        $("#lcl_progressbar")
          ...
          .removeAttr("style")
          .css("width", 0)
          .animate({ width: "100%" }, time, "linear", function () {
    ...
    var enter_fullscreen = function (set_browser_status, on_opening) {
      ...
      if (
        !lcl_shown ||
        !lcl_ai_opts.fullscreen ||
        (!on_opening && lcl_is_active)
      ) {
        return false;
      }
      ...
      setTimeout(function () {
        ...
        $(document).on("lcl_resized_window", function () {
          ...
          if (
            on_opening ||
            (lcl_curr_opts.data_position == "under" &&
              !$(".lcl_force_txt_over").length)
          ) {
    ...
    var fs_img_manag = function (img_sizes) {
      ...
      if (
        ...
        img_sizes.w <= $("#lcl_subj").width() &&
        img_sizes.h <= $("#lcl_subj").height()
      ) {
      ...
      // smart - fill only if is bigger than screen or same aspect ratio
        ...
        var ratio_diff =
          $(window).width() / $(window).height() - img_sizes.w / img_sizes.h;
        ...
        if (v.type != "unknown") {
          ...
          if (v.thumb) {
            ...
            switch (v.type) {
              ...
              case "vimeo":
                if (v.poster) {
                  ...
                  if (
                    typeof lcl_ai_vars.vimeo_thumb_cache[v.src] == "undefined"
                  ) {
                    tpc = "lcl_tn_preload";
                    ...
                    $.getJSON(
                      ...
                      function (data) {
                        // need async
                        thumbs_nav_img_preload(
                          data[0].thumbnail_large,
                          i,
                          uniq_id
                        );
                        lcl_ai_vars.vimeo_thumb_cache[v.src] =
                          data[0].thumbnail_large;

                        // use ATTR to avoid issues with IE10
                        $(".lcl_tn_inner li[rel=" + i + "]").attr(
                          "style",
                          $(".lcl_tn_inner li[rel=" + i + "]").attr("style") +
              ...
              case "dailymotion":
                bg_img = v.poster
                  ? v.poster
                  : "http://www.dailymotion.com/thumbnail/video/" + v.video_id;
                break;
            }
            ...
            if (bg_img) {
              // has thumbs maker?
              if (
                lcl_ai_opts.thumbs_maker_url &&
                (v.poster ||
                  $.inArray(v.type, ["youtube", "vimeo", "dailymotion"]) === -1)
              ) {
                var base = lcl_ai_opts.thumbs_maker_url;
                bg_img = base
                  .replace("%URL%", encodeURIComponent(bg_img))
                  .replace("%W%", lcl_ai_opts.thumbs_w)
                  .replace("%H%", lcl_ai_opts.thumbs_h);
              }
    ...
    var thumbs_nav_img_preload = function (img_url, el_index, uniq_id) {
      $("<img/>")
        .bind("load", function () {
          ...
          $(
            "#lcl_thumbs_nav[rel=" + uniq_id + "] li[rel=" + el_index + "]"
    ...
    var thumbs_nav_scroll_to_item = function (elem_id) {
      ...
      var to_center = Math.floor(
        ($(".lcl_tn_inner").width() - elem_w - margin) / 2
      );

      var new_offset =
        elem_w * id + margin * (id - 1) + Math.floor(margin / 2) - to_center;

      $(".lcl_tn_inner")
        .stop(true)
        .animate({ scrollLeft: new_offset }, 500, function () {
    ...
    if (!lcl_vars.is_arr_instance) {
      if (lcl_settings.live_elements && lcl_vars.elems_selector) {
        // switch between static and dynamic elements retrieval

        $(document)
          .off("click", lcl_vars.elems_selector)
    ...
    $(document).on(
      ...
      function (e) {
        ...
        if (
          !$target.is("#lcl_window") &&
          !$target.parents("#lcl_window").length
        ) {
          e.preventDefault();
    ...
    $(document).on("click", ".lcl_elem", function (e) {
      ...
      if (
        ...
        $.inArray($("#lcl_wrap").attr("lcl-type"), ["video"]) !== -1
      ) {
        lcl_stop_slideshow();
    ...
    $(document).on("click", ".lcl_socials", function (e) {
      ...
      if (!$(".lcl_socials > div").length) {
        ...
        var code = '<div class="lcl_socials_tt lcl_tooltip lcl_tt_bottom">';

        if (lcl_curr_opts.fb_share_params) {
          var share_url = page_url;
          share_url += window.location.href.indexOf("?") === -1 ? "%3F" : "%26";
          share_url += encodeURIComponent(
          ...
          code +=
            '<a class="lcl_icon" onClick="window.open(\'https://www.facebook.com/sharer?u=' +
            share_url +
            "&display=popup','sharer','toolbar=0,status=0,width=590,height=500');\" href=\"javascript: void(0)\"><i class=\"fa-brands fa-facebook\"></i></a>";
        } else {
          code +=
            '<a class="lcl_icon" onClick="window.open(\'https://www.facebook.com/sharer?u=' +
            page_url +
        ...
        setTimeout(function () {
          // delay to let CSS execute animation
    ...
    $(document).on(
      "lcl_tn_elem_click" + tn_track_touch,
      ".lcl_tn_inner > li",
      function (e) {
        if (obj != lcl_curr_obj) {
          return true;
      ...
      function (e) {
        ...
        $(".lcl_tn_inner")
          ...
          .animate(
            {
              scrollLeft:
                $(".lcl_tn_inner").scrollLeft() - lcl_curr_opts.thumbs_w - 10,
            },
            300,
            "linear",
            function () {
    ...
    lcl_start_slideshow = function (restart) {
      if (
        !lcl_shown ||
        (typeof restart == "undefined" &&
          typeof lcl_slideshow != "undefined") ||
        !set_curr_vars()
      ) {
        return false;
      }
      ...
      if (
        !o.carousel &&
        lcl_ai_vars.elem_index == lcl_ai_vars.elems.length - 1
      ) {
        return false;
      }
