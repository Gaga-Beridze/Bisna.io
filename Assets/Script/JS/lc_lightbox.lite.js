			...
			if(!$('.lcl_socials > div').length) {
				...
				'<div class="lcl_socials_tt lcl_tooltip lcl_tt_bottom">';
					...
					if(lcl_curr_opts.fb_share_params) {
						...
						code += '<a class="lcl_icon" onClick="window.open(\'https://www.facebook.com/sharer?u='+ share_url +'&display=popup\',\'sharer\',\'toolbar=0,status=0,width=590,height=500\');" href="javascript: void(0)"><i class="fa-brands fa-facebook"></i></a>';	
					} else {
						code += '<a class="lcl_icon" onClick="window.open(\'https://www.facebook.com/sharer?u='+ page_url +'&display=popup\',\'sharer\',\'toolbar=0,status=0,width=590,height=325\');" href="javascript: void(0)"></a>';	
					}
